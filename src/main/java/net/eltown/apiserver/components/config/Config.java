package net.eltown.apiserver.components.config;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.google.gson.reflect.TypeToken;
import lombok.SneakyThrows;
import net.eltown.apiserver.Loader;
...
public class Config {
    ...
    public static void saveResource(String filename, String outputName, boolean replace/*, Plugin instance*/) {
        File out = new File(Loader.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath().replace("api-server.jar", ""), outputName);
